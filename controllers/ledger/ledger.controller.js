...
let LedgerController = class LedgerController {
    ...
    getFilter(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.services.getFilter();
...
], LedgerController.prototype, "getFilter", null);
__decorate([
    common_1.Get({ path: "/specific/:year/:period", middlewares: [verifyTokenMember] }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, Function]),
    __metadata("design:returntype", Promise)
], LedgerController.prototype, "getSoa", null);
