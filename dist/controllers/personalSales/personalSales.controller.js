...
const personalSales_service_1 = require("./personalSales.service");
const { verifyTokenMember } = require("../../middleware/index");
const _ = require("lodash");
let PersonalSalesController = class PersonalSalesController {
...
], PersonalSalesController.prototype, "getFilter", null);
__decorate([
    common_1.Get({ path: "/specific/:date/:period", middlewares: [verifyTokenMember] }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, Function]),
    __metadata("design:returntype", Promise)
], PersonalSalesController.prototype, "getData", null);
PersonalSalesController = __decorate([
    core_1.Controller({
        model: "./personalSales.model",
        route: "/personalSales"
    }),
    __metadata("design:paramtypes", [personalSales_service_1.PersonalSalesServices])
], PersonalSalesController);
exports.PersonalSalesController = PersonalSalesController;
