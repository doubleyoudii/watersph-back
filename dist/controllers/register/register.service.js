    ...
    verifyMemberId(body) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return {
                    status: 200,
                    message: "Activation on process, Please check your email for verification",
                    data: { payload, token },
                    meta: {}
                };
            }
    ...
    postEditReg(id, body) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const dealer = yield this.model.findOneAndUpdate({ memberId: id }, { $set: newBody }, {
                    new: true
                });
                return {
                    status: 200,
...
__decorate([
    mongo_1.Models("register"),
    __metadata("design:type", Object)
], RegisterServices.prototype, "model", void 0);
